...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        // Dealer's turn if the player "Stay" 
        System.out.println("\nDealer's turn");
        System.out.println("\n The dealer's card's \n" + cardString(dealerCard1) + "\nand a \n" + cardString(dealerCard2));
        System.out.println("Delar's total " + dealerTotal);
     ...
     */
     public static int drawRandomCard(){
        double ramdomNumber = Math.random() * 13;
        ramdomNumber += 1;
        return (int)ramdomNumber;
